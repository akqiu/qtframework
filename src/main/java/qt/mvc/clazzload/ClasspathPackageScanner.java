...
import qt.mvc.common.StringUtil;
...
public  class ClasspathPackageScanner  {
    private Logger logger = Logger.getLogger(ClasspathPackageScanner.class);
    ...
    public List<String> getFullyQualifiedClassNameList() throws IOException {
        ...
        for (String packageName : basePackageArray) {
            System.out.println("["+i+++"]"+packageName);
            temp = doScan(packageName, new ArrayList<String>());
    ...
    public static void main(String[] args) throws Exception {
        ...
        //ClasspathPackageScanner scan = new ClasspathPackageScanner(ConstantClass.SCANNER_PATH);

        //List<String> lst = scan.getFullyQualifiedClassNameList();

        MVCClassManager manager = new MVCClassManager();

        System.out.println("Size:"+manager.getClassList().size());
